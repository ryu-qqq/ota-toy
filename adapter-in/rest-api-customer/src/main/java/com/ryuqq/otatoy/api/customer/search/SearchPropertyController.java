...
/**
 * 고객 숙소 검색 Controller.
 * CustomerSearchPropertyUseCase만 의존하며, 비즈니스 로직 없이 HTTP 변환만 수행한다.
 *
 * @author ryu-qqq
 * @since 2026-04-06
 */
...
public class SearchPropertyController {
    ...
    public SearchPropertyController(CustomerSearchPropertyUseCase customerSearchPropertyUseCase) {
