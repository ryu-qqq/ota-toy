...
2. **객실 + 편의시설이 같은 단계** — 해외 OTA(B사)과 동일하게 객실 등록 시 편의시설 함께 설정
...
- [해외 OTA(B사) - Registering your property](https://partner.booking.com/en-us/help/working-booking/going-live/registering-your-property)
- [해외 OTA(B사) - Setting up your property page](https://partner.booking.com/en-us/learn-more/new-partner/setting-your-property-listing)
- [해외 OTA(B사) - Changing property description or room details](https://partner.booking.com/en-us/help/property-page/general-info/changing-your-property-description-or-room-details)
- [해외 OTA(B사) Extranet Guide - BnB Management London](https://bnbmanagementlondon.co.uk/booking-com-extranet-guide/)
- [해외 OTA(B사) Extranet Guide - SiteMinder](https://www.siteminder.com/r/trends-advice/hotel-management-tips-ideas/booking-com-extranet/)
- [해외 OTA(B사) Extranet Guide - SmartOrder](https://www.smartorder.ai/resources/blog/booking-com-extranet/)
- [국내 OTA(야사) 파트너센터](https://partner.yanolja.com/)
- [국내 OTA(야사) 파트너센터 운영 가이드](https://koreastrb.moneyenter.com/489)
