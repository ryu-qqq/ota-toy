...
| 신규 숙소 | O | "Booking.com 신규 숙소" (일부) | Property.isNew |
...
| prices.nonCoupon.supplierCode | "AGODA" | Rate.supplier |
...
| 필드 | EPS (익스피디아) | AGODA (아고다) | DOTW (웹베즈) |
|------|------------------|----------------|---------------|
| supplierType | EPS | AGODA | DOTW |
| supplierNameKr | 익스피디아 | 아고다 | 웹베즈 |
| title | Travelscape LLC | Agoda Company Pte. Ltd. | WebBeds FZ-LLC |
...
| email | support@chat.travelnow.com | cs_partners@agoda.com | kor-customerservice@webbeds.com |
| terms | URL | null | null |
...
1. **멀티 서플라이어 가격 비교**: 같은 객실에 대해 EPS, AGODA, DOTW 세 공급자의 가격을 비교하여 최저가 제공
...
| **숙소 성급** | 1~5성급 + **Agoda Luxe (NEW)** | **자체 등급 시스템** "Agoda Luxe" 추가 |
...
| 할인율 | O | "-14%" | 퍼센트 뱃지 |
| **쿠폰 할인** | O | "AGODASPONSORED 적용됨 - ₩13,554 할인!" | **쿠폰 할인 금액을 명시적으로 표시** |
| 잔여 객실 | O | "객실 1개 남음" | |
...
6. **Agoda Luxe** — 플랫폼 자체 등급 시스템. starRating 외에 platformGrade가 필요할 수 있음
