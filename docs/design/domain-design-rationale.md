...
## 7. Extranet 등록 흐름과 UseCase 분리 (docs/research/ota-extranet-registration-flow.md)
...
| 문서 | 경로 | 내용 |
|------|------|------|
| OTA 플랫폼 분석 | docs/research/ota-platform-analysis.md | 해외 2 + 국내 1 크롤링 상세 |
| 크로스 플랫폼 비교 | docs/research/cross-platform-comparison.md | 공통/차별 필드 비교표 |
| 도메인 검증 | docs/research/domain-validation.md | 초안 vs 실제 데이터 대조 |
| Extranet 등록 흐름 | docs/research/ota-extranet-registration-flow.md | 등록 단계별 분리 근거 |
...
| ERD v3 | docs/erDiagram.md | 전체 테이블 관계도 |
